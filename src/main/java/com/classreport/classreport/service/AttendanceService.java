...
public class AttendanceService {
    ...
    public ApiResponse update(AttendanceUpdateRequest request) throws Throwable {
        ...
        List<LessonInstanceEntity> lessonInstances = null;
        try {
            lessonInstances = lessonInstanceRepository
