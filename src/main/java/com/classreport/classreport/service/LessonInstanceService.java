...
import com.classreport.classreport.exception.AlreadyExistsException;
import com.classreport.classreport.exception.NotFoundException;
...
//                instance.setGroup(schedule.getGroup());
    ...
    @Transactional
    public ApiResponse confirmLesson(Long id) throws BadRequestException {
        ...
        if (!lessonSchedule.getDaysOfWeek().contains(todayDay)){
            throw new BadRequestException("Today Haven't Lesson");
        }
